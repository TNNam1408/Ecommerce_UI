...
class _ProductImagesState extends State<ProductImages> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        SizedBox(
          width: getProPortionateScreenWight(238),
          child: AspectRatio(
            aspectRatio: 1,
  ...
  GestureDetector buildSmallPreview(int index) {
    return GestureDetector(
      ...
      child: Container(
        margin: EdgeInsets.only(right: getProPortionateScreenWight(15)),
        padding: EdgeInsets.all(getProPortionateScreenWight(8)),
        height: getProPortionateScreenWight(48),
        width: getProPortionateScreenWight(48),
