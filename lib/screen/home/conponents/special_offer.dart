      ...
      children: [
        ...
        SingleChildScrollView(
          ...
          child: Row(
            children: [
              SpecialOfferCard(
                image: "assets/images/mac banner.jpg",
                category: "MacBook",
                numOfBrands: 2,
                press: () {},
              ),
              ...
              SpecialOfferCard(
                image: "assets/images/legion banner.jpg",
...
class SpecialOfferCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: SizedBox(
        width: getProPortionateScreenWight(242),
        height: getProPortionateScreenWight(100),
        child: ClipRRect(
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsets.symmetric(
                  horizontal: getProPortionateScreenWight(15),
                  vertical: getProPortionateScreenWight(10),
                ),
                child: Text.rich(
                  TextSpan(
